This is a [Next.js](https://nextjs.org/) project bootstrapped with [`create-next-first-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-first-app).
